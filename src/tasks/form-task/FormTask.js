...
export const FormTask = () => (
  <div>
    <p>
      For this task you need to implement the form shown in the image below the logic for saving the below (
    ...
    <ul>
      ...
      <li>
        ...
        {' '}
        (This format should also be configurable).
      </li>
    ...
    <ul>
      ...
      <li>
        When submitting the form, you should use the
        <code>saveUserForm</code>
        {' '}
        function found in
      ...
      <li>
        <strong>Testing is required for this task.</strong>
        {' '}
        The testing-library has been included in this project, but please feel free to use any other testing tools (such as enzyme)
      </li>
    </ul>
    ...
    <div>
      <div style={{ display: 'flex' }}>
        <div style={{
          width: 'calc(50% - 1px)', height: 435, borderRight: '1px solid grey', padding: 10,
        }}
        >
          <FormTaskComplete />
        </div>
